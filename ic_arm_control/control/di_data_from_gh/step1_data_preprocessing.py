...
def main():
    ...
    # 输入转换后的数据文件
    converted_files = [
        "/Users/lr-2002/project/instantcreation/IC_arm_control/dyn_ana_for_mat/dynamics_ic_can_log_20251015_145900_414.csv",
        "/Users/lr-2002/project/instantcreation/IC_arm_control/dyn_ana_for_mat/dynamics_ic_can_log_20251015_145946_130.csv",
        "/Users/lr-2002/project/instantcreation/IC_arm_control/dyn_ana_for_mat/dynamics_ic_can_log_20251015_150027_011.csv",
    ]
    ...
    for i, csv_file in enumerate(converted_files):
        ...
        try:
            ...
            q_filtered, dq_filtered, ddq_filtered, tau_filtered = (
                preprocessor.process_trajectory_data(
                    q_raw,
                    dq_raw,
                    tau_raw,
                    time_array,
