...
def save_trajectory_for_executor(t, q, qd, q2d, mat_file_path):
	...
	output_filename = os.path.join(output_dir, f"{mat_basename}_trajectory_{control_freq}hz.json")
	...
	print(f"采样频率: 250Hz")
	print(f"\n可以使用以下命令执行轨迹:")
	print(f"  mjpython tools/trajectory_executor.py {output_filename} mujoco")
	print(f"  或")
