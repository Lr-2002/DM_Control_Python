...
if __name__ == "__main__":
    try:
        ...
        with Motor_Control(1000000, 5000000,"F561E08C892274DB09496BCC1102DBC5",init_data1) as control:
            input('go on ? ')
            ...
            while running.is_set():
                    ...
                    for id in id_list: 
                        ...
                        control.control_mit(control.getMotor(id), 0, 0, 0, 0, 0)
                        ...
                        print(f"canid is: {id} pos: {pos} vel: {vel} effort: {tau} time(s): {interval}")
