...
# 使用新的统一电机控制系统
from control.unified_motor_control import (
    DamiaoProtocol,
    HTProtocol,
    MotorManager,
    MotorInfo,
...
from control.ht_motor import HTMotorManager
from control.servo_motor import ServoMotorManager
from control.src import usb_class
from control.usb_hw_wrapper import USBHardwareWrapper
